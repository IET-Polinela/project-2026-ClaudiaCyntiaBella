    ...
    def handle(self, *args, **kwargs):
        ...
        context_data = {
            ...
            'Lampu Mati': {
                ...
                'desc': 'Lampu jalan di area ini mati total sehingga membahayakan pengguna jalan pada malam hari.'
            },
            'Drainase': {
                'titles': [
                    'Saluran Air Mampet',
            ...
            'Keamanan': {
                ...
                'desc': 'Dibutuhkan patroli tambahan karena terdapat laporan aktivitas mencurigakan.'
            }
        }
